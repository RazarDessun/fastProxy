exports.config = {
	...
	poiKeywordServer: {"code":11,"desc":"关键字列表查询服务","resType":"json","reqType":"","reqMethod":"POST","headers":"mobileid,version","analysis":"",
				    "host":"nvdserver2.lbs8.com","port":9000,"reqPath":"/QueryServer3.0/queryAjax_getSearchListTerm.htm",
				    "isjson":1,"gzip":0},
	poiListServer: {"code":1,"desc":"poi列表服务","resType":"json","reqType":"","reqMethod":"GET","headers":"","analysis":"",
				    "host":"nvdserver2.lbs8.com","port":9000,"reqPath":"/QueryServer3.0/queryAjax_resList.htm",
				    "isjson":1,"gzip":1},
	poiListInfoServer: {"code":1,"desc":"poi列表信息服务","resType":"","reqType":"","reqMethod":"GET","headers":"","analysis":"",
				    "host":"nvdserver2.lbs8.com","port":9000,"reqPath":"/QueryServer3.0/queryAjax_searchCommonList.htm",
				    "isjson":1,"gzip":1},
	poiDetailServer: {"code":1,"desc":"poi详情","resType":"","reqType":"","reqMethod":"GET","headers":"","analysis":"",
				    "host":"nvdserver2.lbs8.com","port":9000,"reqPath":"/QueryServer3.0/queryAjax_single.htm",
				    "isjson":1,"gzip":1},
	loginServer: {"code":1,"desc":"","resType":"","reqType":"","reqMethod":"GET","headers":"","analysis":"",
				    "host":"nvdserver.lbs8.com","port":9000,
				    "reqPath":"","isjson":1,"gzip":1},
	rvsServer: {"code":1,"desc":"","resType":"","reqType":"","reqMethod":"GET","headers":"","analysis":"",
				    "host":"nvdserver.lbs8.com","port":9000,
				    "reqPath":"","isjson":1,"gzip":1},
	mapServer: {"code":1,"desc":"","resType":"","reqType":"","reqMethod":"GET","headers":"","analysis":"",
				    "host":"nvdserver.lbs8.com","port":9000,
				    "reqPath":"","isjson":1,"gzip":1},
	npsServer: {"code":1,"desc":"","resType":"","reqType":"","reqMethod":"GET","headers":"","analysis":"",
				    "host":"nvdserver.lbs8.com","port":9000,
				    "reqPath":"","isjson":1,"gzip":1},
	rtsServer: {"code":1,"desc":"","resType":"","reqType":"","reqMethod":"GET","headers":"","analysis":"",
				    "host":"nvdserver.lbs8.com","port":9000,
				    "reqPath":"","isjson":1,"gzip":1},
	queryServer: {"code":1,"desc":"","resType":"","reqType":"","reqMethod":"GET","headers":"","analysis":"",
				    "host":"nvdserver.lbs8.com","port":9000,
				    "reqPath":"","isjson":1,"gzip":1},
	scenicServer: {"code":1,"desc":"","resType":"","reqType":"","reqMethod":"GET","headers":"","analysis":"",
				    "host":"nvdserver.lbs8.com","port":9000,"reqPath":"",
				    "isjson":1,"gzip":1},
	friendServer: {"code":81,"desc":"位置分享","resType":"","reqType":"",	"reqMethod":"GET","headers":"","analysis":"",
				    "host":"nvdserver.lbs8.com","port":9000, "reqPath":"/navidog2Application/navidog4x/locationShareNavidog4x_location_share.htm",
				   "isjson":1,"gzip":1},
	edriverServer: {"code":1,"desc":"","resType":"","reqType":"","reqMethod":"GET","headers":"","analysis":"",
				    "host":"nvdserver.lbs8.com","port":9000,
				    "reqPath":"","isjson":1,"gzip":1},
	shorturlServer: {"code":1,"desc":"","resType":"","reqType":"","reqMethod":"GET","headers":"","analysis":"",
				    "host":"nvdserver.lbs8.com","port":9000,
				    "reqPath":"","isjson":1,"gzip":1},
	themeServer: {"code":1,"desc":"","resType":"","reqType":"","reqMethod":"GET","headers":"","analysis":"",
				    "host":"nvdserver.lbs8.com","port":9000,
				    "reqPath":"","isjson":1,"gzip":1},
	themegisServer: {"code":1,"desc":"","resType":"","reqType":"","reqMethod":"GET","headers":"","analysis":"",
				    "host":"nvdserver.lbs8.com","port":9000,
				    "reqPath":"","isjson":1,"gzip":1},
	mapDownload: {"code":1,"desc":"","resType":"","reqType":"","reqMethod":"GET","headers":"","analysis":"",
				    "host":"nvdserver.lbs8.com","port":9000,
				    "reqPath":"","isjson":1,"gzip":1},
	userloginServer: {"code":1,"desc":"","resType":"","reqType":"","reqMethod":"GET","headers":"","analysis":"",
				    "host":"nvdserver.lbs8.com","port":9000,
				    "reqPath":"","isjson":1,"gzip":1},
	registphoneServer: {"code":1,"desc":"","resType":"","reqType":"","reqMethod":"GET","headers":"","analysis":"",
				    "host":"nvdserver.lbs8.com","port":9000,
				    "reqPath":"","isjson":1,"gzip":1},
	error: {"code":1,"desc":"","resType":"","reqType":"","reqMethod":"GET","reqPath":"","headers":"","analysis":"",
				    "host":"nvdserver.lbs8.com","port":9000,
				    "isjson":1,"gzip":1},
	navidog2NewsServer: {"code":1,"desc":"","resType":"","reqType":"","reqMethod":"GET","headers":"","analysis":"",
				    "host":"nvdserver.lbs8.com","port":9000,
				    "reqPath":"","isjson":1,"gzip":1},
	testServerPost: {"code":171,"desc":"测试post","resType":"","reqType":"","reqMethod":"GET","reqPath":"","isjson":0,"gzip":0},
	testServerGet: {"code":181,"desc":"测试get","resType":"测试get","reqType":"","reqMethod":"GET","reqPath":"","isjson":0,"gzip":0},
